...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function command($signature, $callback){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \TruckerTracker\Console\Kernel::command($signature, $callback);
        }
    ...
    class Auth extends \Illuminate\Support\Facades\Auth{
         ...
         * @param mixed $id
         * @param bool $remember
         * @return \TruckerTracker\User|false 
         * @static 
         */
    ...
    class SSE extends \Sse\Laravel\Facade\SSE{
         ...
         * @static 
         */
        public static function sendBlock($id, $data, $name = null){
            return \Sse\SSE::sendBlock($id, $data, $name);
        }
         ...
         * @static 
         */
        public static function isTick(){
            return \Sse\SSE::isTick();
        }
