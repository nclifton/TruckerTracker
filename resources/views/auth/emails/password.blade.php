<?php
$action_url = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset())
?>
...
<head>
    ...
    <title>Choose a new password for Trucker Tracker</title>
            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="email-masthead">
                        <a class="email-masthead_name">Trucker<img src="http://truckertracker.services/images/Maps-Gps-Receiving-icon.png"/>Tracker Services</a>
                    </td>
                </tr>
                <!-- Email Body -->
                <tr>
                        ...
                        <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td class="content-cell">
                                    <h1>Hi {{$user->name}},</h1>
                                    <p>You recently requested to reset your password for your Trucker Tracker account. Click the button below to reset it.</p>
                                    <!-- Action -->
                                    ...
                                    <p>Thanks,<br>Neil and the Trucker Tracker Team</p>
                ...
                <tr>
                    <td>
                        <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-cell">
                                    <p class="sub center">&copy; 2016 Clifton Web Foundry. All rights reserved.</p>
                                    <p class="sub center">
                                        <a href="http://cliftonwebfoundry.com.au"><img src="http://truckertracker.services/images/cliftonwebfoundry.png" alt="Clifton IT Foundries Pty Ltd Trading As Clifton Web Foundry"/></a>
                                    </p>
                                </td>
                            </tr>
                        </table>
